let canvas,mover,gravity,wind;
let mu = 0.3;

function setup() {
  canvas = createCanvas(400,400);  
  background(0);  
  mover = new ball(random(20,50),random(width),200);
...
function draw() {
  ...
  gravity = gravity.mult(mover.mass);
